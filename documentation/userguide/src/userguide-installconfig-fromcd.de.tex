...
apt-cdrom add
\end{verbatim}
bekannt gemacht wurde (die CD muß sich hierzu im Laufwerk befinden).

% Installation von termserv.berlios.de mit http?
...
Tabellen evtl. in den Anhang? Ich denke, eine halbe Seite Tabellen ist okay, das 
kann da bleiben.
