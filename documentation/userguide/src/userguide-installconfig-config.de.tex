...
aufrufen, z.B. \texttt{http://192.168.0.254:10000/}, erscheint folgender
Anmeldebildschirm:
...
\texttt{/etc/dhcpd.conf} auf Arktur nötig:
...
Tabelle der auf Arktur voreingerichteten Adreßbereiche findet sich auf Seite
\pageref{dns-arktur}.
...
werden soll.
Er muß sich auf dem oben angegebenen Rechner (hier \texttt{termserv})
...
\item Wenn die in Tabelle \ref{dns-arktur} angegebenen IP-Adreßbereiche
