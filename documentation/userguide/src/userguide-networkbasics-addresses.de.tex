...
Die Rechner in einem Netzwerk benötigen eindeutige Adressen. Dies ist vergleichbar
mit der Post, die ebenfalls eindeutige Adressen zum Befördern benötigt.
...
Eine MAC-Adresse besteht aus sechs zweistelligen Hexadezimalzahlen, die durch
Doppelpunkte getrennt sind, wie etwa \emph{00:0D:84:F6:3A:10}. 
...
\subsection{Rechnernamen und Domänen}
...
mit dem Namen \emph{arktur}. Das Länderkürzel heißt Top-Level-Domain (kurz TLD),
davor kommt die Domäne, davor dann entweder Rechner oder weitere Domänen.
 
 
\subsubsection*{Beispiel}
 
Das oben genannte Beispielnetzwerk hat auf dem Server eine DNS-Serversoftware
installiert. Die Rechner erhalten nun Namen. 
